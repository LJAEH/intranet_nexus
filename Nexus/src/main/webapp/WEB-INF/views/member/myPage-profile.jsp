  ...
  <section>
    ...
    <div class="content-all-page">
      ...
      <div class="content-all-top-area">
        ...
        <p class="content-all-top-text2">프로필</p>
        <!-- 선 -->
      ...
      <div class="content-all-bottom-area">
        ...
        <div class="myPage-profile">
          ...
          <div>
            <p class="myPage-profile-detail" id="myPage-profile-name">${loginMember.memName} / ${loginMember.deptName}</p>
            <p class="myPage-profile-detail" id="myPage-profile-email">${loginMember.memEmail}</p>
            <p class="myPage-profile-detail" id="myPage-profile-phone">${loginMember.memTel}</p>
            <p class="myPage-profile-detail" id="myPage-profile-rank">${loginMember.jobName}</p>
            <p class="myPage-profile-detail" id="myPage-profile-date">${loginMember.enrollDate}</p>
          </div>
        ...
        <div class="myPage-group">
          <h1>조직</h1>
          <span>${loginMember.deptName} - ${loginMember.teamName}</span>
        </div>
      </div>
